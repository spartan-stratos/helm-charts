...
| datadog.enabled                                                                                                                                                   | Add default global environment variables for Datadog configuration and enable native Kubernetes sidecar wiring for the `datadog-agent` sidecar      | false        |
