...
| keda.fallback                                                                                                                                                     | Replica count to hold while the scaler cannot fetch metrics. Requires AverageValue triggers                                                        | {}           |
...
| keda.fallback.behavior                                                                                                                                            | static, currentReplicas, currentReplicasIfHigher or currentReplicasIfLower                                                                         | null         |
